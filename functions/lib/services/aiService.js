...
exports.exemplosMensagensIA = exports.aiMessageTemplates = void 0;
exports.gerarMensagemIA = gerarMensagemIA;
exports.classificarTransacao = classificarTransacao;
/**
 * Templates de mensagens da IA em português correto
 */
exports.aiMessageTemplates = [
    {
        tipo: 'economia',
 ...
 */
function gerarMensagemIA(template, variaveis) {
        ...
        template.variaveis.forEach(variavel => {
            ...
            if (valor !== undefined) {
                ...
                if (typeof valor === 'number' && variavel.includes('valor') || variavel.includes('saldo') || variavel.includes('receitas') || variavel.includes('despesas')) {
                    mensagem = mensagem.replace(`\${${variavel}}`, valor.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 }));
                }
                else {
 ...
 */
exports.exemplosMensagensIA = {
    economia: gerarMensagemIA(exports.aiMessageTemplates[0], {
        valor: 350,
        categoria: 'delivery',
        percentual: 15,
        valorSugerido: 150,
    }),
    meta: gerarMensagemIA(exports.aiMessageTemplates[1], {
        valorRestante: 5000,
        tituloMeta: 'Viagem',
        valorAporte: 200,
        meses: 25,
    }),
    divisao: gerarMensagemIA(exports.aiMessageTemplates[5], {
        saldoConjunto: 2500,
